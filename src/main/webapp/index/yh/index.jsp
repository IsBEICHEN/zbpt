...
<div class="header bg-main">
  ...
  <div class="head-l">
   <a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 用户 : ${sessionScope.account}</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul>
    <li><a href="user/selTea" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
  ...
  <ul>
    <li><a href="comm/selLb" target="right"><span class="icon-caret-right"></span>公告信息</a></li> 
  </ul>
    <h2><span class="icon-pencil-square-o"></span>任务管理</h2>
  <ul>
    <li><a href="comm/selCou" target="right"><span class="icon-caret-right"></span>任务信息</a></li> 
    <li><a href="comm/selXk" target="right"><span class="icon-caret-right"></span>接取任务信息</a></li>
  </ul>  
   <h2><span class="icon-pencil-square-o"></span>留言管理</h2>
  <ul>
    <li><a href="comm/selLy" target="right"><span class="icon-caret-right"></span>留言信息</a></li>               
  </ul> 
</div>
<script type="text/javascript">
$(function(){
