...
<form action = "comm/addLy" method = "post"   class="validate" onsubmit="return add();" >
	<div class="formbody">
		<div class="formtitle"><span>基本信息</span></div>
		<ul class="forminfo">
			<li>
				<label>用户</label>
				<select class="dfinput" name="jid" id="role">
			...
			<li>
				<label>标题</label>
				<input name="title" id="account" type="text" class="dfinput  " placeholder="请输入标题" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			 <li>
				<label>备注</label>
