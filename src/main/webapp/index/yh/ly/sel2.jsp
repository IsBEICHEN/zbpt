...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="comm/tzly">添加留言</a></li>
				</ul>
			</div>
		</div>
	<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="comm/selLy?page=1">首页</a></li>
        <li class="paginItem"><a href="comm/selLy?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="comm/selLy?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="comm/selLy?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
