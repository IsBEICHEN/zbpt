...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<c:if test="${!empty courseList}">
			...
			<tr>
				...
				<c:if test="${list.state!='未接取'}">
					<a href = "comm/selXk?sId=${list.id}"><font color="red">${list.state}</font></a>
				</c:if>
					<c:if test="${list.state=='未接取'}">
					${list.state}
				</c:if>
				...
				<td>
					<a href = "comm/showCou?cid=${list.id}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href = "comm/deleteCou?id=${list.id}"><font color="blue">删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="comm/tz">发布任务信息</a></li>
				</ul>
			</div>
		</div>
	<div class="pagin">
