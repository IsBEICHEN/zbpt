...
<body>
<form action="comm/selTj" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">任务管理</a></li>
...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>工人</label>
			<input name="account"  type="text" class="dfinput" placeholder="请输入工人" />
		</li>
		<li>
			<label>钱包</label>
			<input name="jsnumber"  type="text" class="dfinput" placeholder="请输入钱包" />
		</li>
		<li>
			<label>&nbsp;</label>
	...
	<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="comm/selTj?page=1">首页</a></li>
        <li class="paginItem"><a href="comm/selTj?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="comm/selTj?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="comm/selTj?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
