...
<body>
<form action="comm/selGra" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">评价管理</a></li>
...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<li>
			<label>工人姓名</label>
			<input name="account"  type="text" class="dfinput" placeholder="请输入工人姓名" />
		</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty graList}">
			...
			<tr>
				...
				<td>${list.content}</td>
				<td>
					<a href = "comm/deleteGra?id=${list.id}"><font color="blue">删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="comm/selGra?page=1">首页</a></li>
        <li class="paginItem"><a href="comm/selGra?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="comm/selGra?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="comm/selGra?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
