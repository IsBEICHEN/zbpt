...
<div class="place">
	...
	<ul class="placeul">
		<li><a href="#">评价管理</a></li>
		<li><a href="#">添加评价信息</a></li>
	</ul>
</div>

<form action = "comm/addGra" method = "post"  class="validate" onsubmit="return add();" >
		<input name="cId"  value="${data.sId}"  type="hidden" class="dfinput  " />
		<input name="aId"  value="${data.aId}"  type="hidden" class="dfinput  " />
	<div class="formbody">
		<div class="formtitle"><span>基本信息</span></div>
		<ul class="forminfo">
			<li>
				<label>任务名称</label>
				<input name="name" value="${data.kname}"  disabled="disabled" type="text" class="dfinput  "  />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>工人</label>
				<input name="name" value="${data.account}"  disabled="disabled" type="text" class="dfinput  "  />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>评价</label>
				<select class="dfinput" name="fenshu" id="role">
