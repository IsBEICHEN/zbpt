...
<body>
<form action="comm/selKh" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">钱包管理</a></li>
		<li><a href="#">查看钱包信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
				<label>标题</label>
				<input name="kname" type="text" class="dfinput required" placeholder="请输入标题" />
			</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.khjb}</td>
				<td>
					<a href = "comm/deleteKh?id=${list.id}"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
				<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="index/admin/kh/add.jsp">添加钱包</a></li>
				</ul>
			</div>
		</div>
	<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="comm/selKh?page=1">首页</a></li>
        <li class="paginItem"><a href="comm/selKh?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="comm/selKh?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="comm/selKh?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
