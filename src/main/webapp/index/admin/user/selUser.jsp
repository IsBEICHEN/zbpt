...
<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="user/selHc?page=1">首页</a></li>
        <li class="paginItem"><a href="user/selHc?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="user/selHc?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="user/selHc?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
