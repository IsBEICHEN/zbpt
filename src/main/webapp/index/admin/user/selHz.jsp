...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<li>
			<label>账户</label>
			<input name="state"  type="text" class="dfinput" placeholder="请输入账户" />
		</li>
		<li>
			<label>&nbsp;</label>
		...
		<c:if test="${!empty userList}">
			...
			<tr>
				...
				<td>${list.jsnumber}</td>
				<td>
				<c:if test="${list.jsnumber<60}">
					<a href = "comm/tzyj?id=${list.id}"><font color="blue">支付押金</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</c:if>
					<a href = "user/tzcz?id=${list.id}"><font color="blue">充值</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="user/selHz?page=1">首页</a></li>
        <li class="paginItem"><a href="user/selHz?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="user/selHz?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="user/selHz?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
