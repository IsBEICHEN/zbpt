...
<div class="header bg-main">
  ...
  <div class="head-l">
   <a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 工人 : ${sessionScope.account}</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul>
    <li><a href="user/selStu" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
