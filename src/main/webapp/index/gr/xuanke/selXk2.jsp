...
<body>
<form action="comm/selXk" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">接取任务管理</a></li>
		<li><a href="#">查看接取任务信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<c:if test="${!empty list}">
			...
			<tr>
				...
				<td>${list.name}</td>
				<td>
				<c:if test="${list.state=='已完成'}">
					<a href = "comm/selGra?sId=${list.id}"><font color="red">${list.state}</font></a>
				</c:if>
					<c:if test="${list.state!='已完成'}">
					${list.state}
				</c:if>
				...
				<td>
					<c:if test="${list.state=='未完成'}">
						<a href = "comm/agreeXk?id=${list.id}"><font color="blue">已完成</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</c:if>
				</td>	
			</tr>
			</c:forEach>
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="comm/selXk?page=1">首页</a></li>
        <li class="paginItem"><a href="comm/selXk?page=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a></li>
        <li class="paginItem"><a href="comm/selXk?page=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}">下一页</a></li>
        <li class="paginItem"><a href="comm/selXk?page=${pageInfo.pages}">尾页</a></li>
        </ul>
    </div>
</form>
