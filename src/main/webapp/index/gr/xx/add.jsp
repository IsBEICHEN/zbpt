	...
	<div class="formbody">
		...
		<ul class="forminfo">
		 <li>
			...
			<li>
				<label>标题</label>
				<input name="title" id="sale" type="text" class="dfinput required" placeholder="请输入标题" />&nbsp&nbsp&nbsp&nbsp<font color="red">*</font>
			</li>
			<li>
				<label>完成质量</label>
				<select name="lx" class="dfinput" id="chexing">
					<option value="">请选择完成质量</option>
